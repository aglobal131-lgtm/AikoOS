...
export class LAppDelegate {
  ...
  if (this.pointBeganEventListener != null) {
  ...
  if (this.pointMovedEventListener != null) {
    document.removeEventListener(
      'pointermove',
  ...
  if (this.pointEndedEventListener != null) {
    document.removeEventListener(
      'pointerup',
  ...
  if (this.pointCancelEventListener != null) {
    document.removeEventListener(
      'pointercancel',
  ...
  if (this.resizeEventListener != null) {
